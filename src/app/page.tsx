    ...
    <>
      ...
      <section className="py-8 sm:py-12 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 text-white text-center md:text-left">
      ...
      <section className="py-10 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-dark text-center mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            ...
            <div className="text-center">
              <div className="mb-3 sm:mb-5 flex justify-center">
                <svg className="w-8 h-8 sm:w-10 sm:h-10 text-primary" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.126 1.126 0 011.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>
              </div>
              <h3 className="font-bold text-dark text-sm sm:text-lg mb-1 sm:mb-2">Family-Owned</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-sm sm:text-lg mb-1 sm:mb-2">Best of Bucks</h3>
              <p className="text-gray-600 text-xs sm:text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-sm sm:text-lg mb-1 sm:mb-2">Local Experts</h3>
              <p className="text-gray-600 text-xs sm:text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-sm sm:text-lg mb-1 sm:mb-2">Licensed & Insured</h3>
              <p className="text-gray-600 text-xs sm:text-sm">
      ...
      <section className="py-10 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center text-sm sm:text-base mb-8 sm:mb-12 max-w-2xl mx-auto">
      ...
      {/* Areas Served */}
      <section
        className="py-10 sm:py-16 lg:py-24 bg-cover bg-center"
      ...
      {/* Contact Section */}
      <section className="py-10 sm:py-16 lg:py-24 bg-gray-50" id="contact">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-dark mb-3 sm:mb-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              <a
                ...
                className="inline-flex items-center justify-center bg-primary text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-primary-dark transition shadow-sm text-base sm:text-lg w-full sm:w-auto"
              >
                Call (267) 414-9751
              </a>
              ...
              <a
                href="/book-online"
                className="inline-flex items-center justify-center bg-accent text-dark font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-accent-dark transition shadow-sm text-base sm:text-lg w-full sm:w-auto"
              >
