        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-lg mb-2">Best of Bucks</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-lg mb-2">Local Experts</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-dark text-lg mb-2">Licensed & Insured</h3>
              <p className="text-gray-600 text-sm">
