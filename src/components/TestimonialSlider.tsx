          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 lg:p-12">
            <div className="flex gap-1 mb-4">
              {[...Array(testimonials[current].rating)].map((_, i) => (
                <span key={i} className="text-accent text-lg md:text-xl">★</span>
              ))}
            </div>
            <blockquote className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed mb-6 italic">
